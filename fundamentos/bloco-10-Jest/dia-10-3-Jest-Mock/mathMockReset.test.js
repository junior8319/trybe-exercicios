/**
 * Teste de reset para a função original
 * mockReset();
 */
 ...
 test("#somar", () => {
   ...
   expect(math.somar(1, 2)).toBe(undefined); // passa neste teste porque com jest.fn() não conseguimos restaurar as implementações originais da função.
   expect(math.somar).toHaveBeenCalledTimes(1);
